...
tf.app.flags.DEFINE_string('log_dir', r"C:\Users\Rag9704\AppData\Local\Programs\Python\Python35\Lib\site-packages\tensorflow\logging", """ dir to store ckpt """)
tf.app.flags.DEFINE_string('image_dir',r"C:\SegNet\CamVid/train.txt", """ path to CamVid image """)
tf.app.flags.DEFINE_string('test_dir', r"C:\SegNet\CamVid/test.txt", """ path to CamVid test image """)
tf.app.flags.DEFINE_string('val_dir', "C:\SegNet\CamVid/val.txt", """ path to CamVid val image """)
